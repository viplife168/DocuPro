!function(a){
	"use strict";function t(e){
		1==a("#light-mode-switch").prop("checked")&&"light-mode-switch"===e?(a("#dark-mode-switch").prop("checked",!1),
		a("#rtl-mode-switch").prop("checked",!1),
		a("#bootstrap-style").attr("href","mini/css/bootstrap.min.css"),
		a("#app-style").attr("href","mini/css/app.min.css"),
		sessionStorage.setItem("is_visited","light-mode-switch")):1==a("#dark-mode-switch").prop("checked")&&"dark-mode-switch"===e?(a("#light-mode-switch").prop("checked",!1),
		a("#rtl-mode-switch").prop("checked",!1),
		a("#bootstrap-style").attr("href","mini/css/bootstrap-dark.min.css"),
		a("#app-style").attr("href","mini/css/app-dark.min.css"),
		...
		a("#bootstrap-style").attr("href","mini/css/bootstrap.min.css"),
		a("#app-style").attr("href","mini/css/app-rtl.min.css"),sessionStorage.setItem("is_visited","rtl-mode-switch"))
	}
	function e(){
	...
	function(){
		a(function(){
			...
			a('[data-plugin="counterup"]').each(function(e,t){a(this).counterUp({delay:s,time:n})})
	}(),
	window.sessionStorage&&((s=sessionStorage.getItem("is_visited"))?(a(".right-bar input:checkbox").prop("checked",!1),
	a("#"+s).prop("checked",!0),t(s)):sessionStorage.setItem("is_visited","light-mode-switch")),
	a("#light-mode-switch, #dark-mode-switch, #rtl-mode-switch").on("change",function(e){t(e.target.id)}),
	a(window).on("load",function(){a("#status").fadeOut(),a("#preloader").delay(350).fadeOut("slow")}),Waves.init()
}
(jQuery);
