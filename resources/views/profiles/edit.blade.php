...
<form class="needs-validation" method="POST" action="{{url('/edit-profile')}}" novalidate>
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <select data-placeholder="Sila Pilih Bahagian...." class="standardSelect form-control mt-5" tabindex="-1" style="display: none;" id="department" name="department" required>
            <option value="{{$department ?? ''}}" selected="selected" label="default">{{$department ?? ''}}</option>
        ...
        <div class="form-group mt-3">
            <div class="input-group">
                ...
                <input class="form-control" id="phone_ext" value="{{$phone_ext}}" name="phone_ext" required>
            </div>
        ...
        <div class="form-group mt-3">
            <div class="input-group">
                ...
                <input class="form-control" id="designation" name="designation" value="{{$designation}}" required>
            </div>
        ...
        <div class="form-group mt-3">
            <div class="input-group">
                ...
                <input class="form-control" id="gred" name="gred" value="{{$gred}}" required>
            </div>
