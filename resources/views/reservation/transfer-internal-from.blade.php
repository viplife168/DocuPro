...
'activePage' => 'transfer-internal-from',
'titlePage' => __('Pindahan Fail Dari Pemegang Fail'),
])
...
use Carbon\Carbon;
@endphp
<form method="POST" action="{{url('pindahan-dalaman-daripada')}}">
    @csrf
    <div class="form-group">
        <div class="row">
            <div class="col-2">
                <span><label for="sender"> Nama Pemegang Fail :</label></span>
            </div>
            <div class="col-8">
