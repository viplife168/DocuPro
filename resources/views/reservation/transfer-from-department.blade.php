...
'activePage' => 'transfer-from-department',
'titlePage' => __('Pindahan Fail Masuk Cawangan'),
])
...
@endphp
<form method="POST" action="{{url('pindah-cawangan-masuk')}}">
    @csrf
    <div class="form-group">
        <div class="row">
            <div class="col-2">
                <span><label for="department"> Permintaan dari Bahagian :</label></span>
            </div>
            <div class="col-8">
            ...
            <div class="col-2">
                <input type="submit" id="btnPilih" name="btnPilih" value="Pilih" class="btn btn-primary btn-block">
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-2">
                <span><label for="penerima"> Nama Pemegang Fail :</label></span>
            </div>
            <div class="col-10">
                <input class="form-control" value="{{$penerima ?? ''}}" type="text" name="penerima" id="penerima" required>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-10">
                <textarea id="catatan" name="catatan" class="form-control" maxlength="225" rows="3" required>{{$catatan ?? ''}}</textarea>
            </div>
        </div>
    </div>
