...
'activePage' => 'transfer-to-department',
'titlePage' => __('Pindahan Fail Keluar Cawangan'),
])
@section('topscripts')
...
@endphp
<form method="POST" action="{{url('pindah-cawangan-keluar/hantar')}}">
    @csrf
    <div class="form-group">
        <div class="row">
            <div class="col-2">
                <span><label for="department"> Hantar ke Bahagian :</label></span>
            </div>
            <div class="col-10">
                <select class="form-control select2" id="to_department" name="to_department" required>
                    @if (!empty($department))
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-2">
                <span><label for="penerima"> Nama Penerima :</label></span>
            </div>
            <div class="col-10">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-10">
                <textarea id="catatan" name="catatan" class="form-control" maxlength="225" rows="3" required></textarea>
            </div>
        </div>
    </div>
